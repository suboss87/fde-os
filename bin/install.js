...
function printSuccess() {
  ...
  console.log('')
  console.log('  1. Copy CLAUDE.md to your project (optional):')
  console.log('     cp ~/.claude/FDEOS-CLAUDE.md.template ./CLAUDE.md')
  console.log('     (Adds FDEOS context to your project. Skip if using Claude Code plugin.)')
  console.log('')
  console.log('  2. Add .fde/ to your .gitignore:')
  console.log('     echo ".fde/" >> .gitignore')
  console.log('     (.fde/ contains sensitive customer data. Keep it local.)')
  console.log('')
  console.log('  3. Open Claude Code in your project and type:')
  console.log('     @fde')
  console.log('')

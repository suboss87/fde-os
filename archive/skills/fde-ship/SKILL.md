...
Talk like a calm tech lead before prod: has anyone actually **run** the rollback, or is it still a slide? If it's only planned, that's today's work — say so plainly.

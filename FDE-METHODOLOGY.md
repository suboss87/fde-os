...
FDEOS implements this methodology as an installable engagement OS: skills plus `.fde/` artifacts so one **human engineer** can run client work end to end with an **AI coding agent** (not a human “agent” on the team).

## What Is an FDE?
Forward Deployed Engineers embed directly with customers, bridging the gap between product capability and enterprise reality. Originated at Palantir, now adopted by Anthropic, OpenAI, Databricks, and others. a16z called it "the hottest job in tech."

## How FDEOS talks

FDEOS is **conversational** — a senior colleague thinking with you, not a form. Skills teach intent and judgment; they are not scripts to read aloud.

## The FDE Principles Encoded in FDEOS
